 ...
 *
 * Copiado de `apps/motorizados/hooks/use-pwa-install.ts` (0227): mismo
 * problema, misma solución. Ver `InstallBanner` en `apps/negocios` para el
 * motivo de por qué esto no es opcional en iOS.
 *
