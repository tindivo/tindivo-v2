          ...
          <div key={grupo.momento} className="mt-4 first:mt-0">
            <div className="mb-2.5 flex items-center gap-2.5 px-0.5">
              ...
              {/* «En este pedido», NO «hoy no».
                  De los dos motivos por los que se bloquea el grupo (`isBlocked`,
                  `exceedsCashCap`), «hoy» es cierto en uno solo. Con
                  `exceedsCashCap` es directamente contraproducente: al cliente
                  le basta quitar un producto para desbloquearlo AHORA, y «hoy
                  no» le dice que vuelva mañana.
                  `isNewUser` ya no bloquea este grupo (0211): un cliente sin
                  historial puede elegir "al recibir" y el servidor decide al
                  confirmar. */}
              {bloqueado && (
