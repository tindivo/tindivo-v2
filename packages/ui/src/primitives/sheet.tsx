...
export function BottomSheet({
  ...
  return (
    ...
    >
      <div
        className="flex w-full max-w-[768px] max-h-[90%] flex-col overflow-hidden rounded-t-[28px] bg-surface text-ink shadow-[0_-20px_60px_-40px_rgba(0,0,0,0.35)] animate-[t-slide-up_280ms_cubic-bezier(0.22,1,0.36,1)]"
        role="dialog"
        aria-modal="true"
      >
