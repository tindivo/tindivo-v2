-- ROLLBACK de 0183 — `get_tracking` deja de exponer `paymentVerifiedAt`.
--
-- Restaura el cuerpo tal cual estaba antes (`pg_get_functiondef` de la
-- definición viva, tomada antes de aplicar la 0183).
--
-- OJO: si se revierte esto SIN revertir también el cliente, la pantalla de
-- cancelado vuelve a decidir solo por la captura y un prepago confirmado en
-- directo vuelve a leerse como «no se te cobró nada». Revierte los dos o
-- ninguno.
