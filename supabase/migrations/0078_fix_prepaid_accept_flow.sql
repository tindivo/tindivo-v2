-- =============================================================================
-- 0078_fix_prepaid_accept_flow.sql
-- Fix Bug: Reincorporar la transición a 'awaiting_payment' en la acción 'accept'
-- de advance_order para pedidos prepaid (perdió el condicional en la migración 0074)
-- =============================================================================
