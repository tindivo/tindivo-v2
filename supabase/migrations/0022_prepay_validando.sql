-- 0022_prepay_validando.sql
-- Fase D (parte 2): el prepago entra a `validando` (espera comprobante + validación del negocio).
-- Mantiene la regla de contraentrega -> validando (número nuevo / con strike / monto grande).
