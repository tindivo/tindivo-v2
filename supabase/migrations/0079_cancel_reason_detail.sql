...
-- 3. Limpieza dinámica por catálogo para evitar sobrecarga de firmas antiguas en pg_proc
DO $$
DECLARE r record;
BEGIN
  FOR r IN
...
-- 4. Actualizar RPC advance_order con enforcement de cancel_reason_detail, cancelled_at y desacoplamiento de rejection_reason_code
