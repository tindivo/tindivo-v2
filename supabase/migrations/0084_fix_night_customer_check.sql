-- =============================================================================
-- 0084 · Corrección de zona horaria America/Lima en check nocturno de create_customer_order
-- =============================================================================

-- 1. Limpieza dinámica por catálogo de firmas
DO $$
DECLARE r record;
BEGIN
  FOR r IN
...
-- 2. RPC create_customer_order con hora de Lima en el check de cliente nuevo nocturno (22:00-06:00 Lima)
