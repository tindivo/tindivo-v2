-- =============================================================================
-- 0105 · Bloquear nuevo pedido si ya hay uno activo de la misma tienda
-- =============================================================================
--
-- QUÉ HACE
-- Agrega un guard al inicio de create_customer_order para evitar que un cliente
-- tenga dos pedidos activos simultáneos en el mismo restaurante.
--
-- POR QUÉ
-- El frontend ya bloquea la experiencia de catálogo cuando detecta un pedido
-- activo, pero el backend no la reforzaba. Esta migración cierra la brecha y
...
-- por seguridad contra versiones previas con firma distinta.
