-- =============================================================================
-- 0033 · Fix: `orders.is_manual` es una columna GENERADA (source = 'business_manual').
-- Las versiones 0031/0032 de create_business_manual_order la insertaban
-- explícitamente, lo que falla en runtime ("cannot insert a non-DEFAULT value
-- into column is_manual"). Esta migración recrea la función sin `is_manual` en el
-- INSERT (se computa sola). Misma firma que 0032. Idempotente.
-- =============================================================================
