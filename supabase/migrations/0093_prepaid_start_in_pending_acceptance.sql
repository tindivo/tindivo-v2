-- =============================================================================
-- 0093 · Pedidos prepago inician en pending_acceptance para confirmación de disponibilidad
-- =============================================================================
-- El restaurante primero debe revisar y aceptar la disponibilidad del pedido ('accept')
-- antes de solicitar la verificación del comprobante de pago ('awaiting_payment').
