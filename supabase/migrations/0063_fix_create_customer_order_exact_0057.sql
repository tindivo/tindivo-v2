-- 0063_fix_create_customer_order_exact_0057.sql
-- Copia 100% idéntica de 0057_contraentrega_guards.sql cambiando únicamente la línea 359:
--   v_status := 'validando';  -->  v_status := 'pending_acceptance';

update public.app_settings
set value = '80'
where key = 'prepay_threshold';
